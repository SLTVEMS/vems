...
import RequestStats from "./components/RequestsPage/RequestStats.jsx";
import RequestTable from "./components/RequestsPage/RequestTable.jsx";

import {
  bootstrapAuthRequested,
  logoutRequested,
} from "./features/auth/auth.actions.js";
...
const RequestsHeader = styled(Box)`
  display: flex;
  ...
  return (
    <div className={`app-shell${isSidebarOpen ? " sidebar-open" : ""}`}>
      ...
      <main className="main-content">
        ...
        <RequestTable requests={visitorRequests} />
      </main>
